        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-6 font-display text-4xl font-extrabold leading-[1.08] tracking-tight text-ink-900 sm:text-5xl lg:text-6xl dark:text-white">
              ...
              <span className="relative whitespace-nowrap text-brand-700 dark:text-brand-400">
                ...
                <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 200 12" fill="none" preserveAspectRatio="none">
                  <path d="M2 9C40 4 160 4 198 9" stroke="#10b981" strokeWidth="3" strokeLinecap="round" />
                </svg>
              </span>{' '}
            ...
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-ink-600 dark:text-ink-300">
              Professional CAC registration services in Port Harcourt with fast processing,
              expert guidance, and reliable customer support.
            </p>

            <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
              <a href={whatsappLink('Hello Mr. David, I would like to register my business with CAC. Please guide me.')} target="_blank" rel="noopener noreferrer" className="btn-accent group">
          ...
          <div className="relative animate-scale-in lg:justify-self-end">
            <div className="relative max-w-md">
              <div className="absolute -left-6 -top-6 z-20 rounded-2xl border border-ink-100 bg-white p-4 shadow-xl shadow-ink-900/10 animate-float dark:border-ink-800 dark:bg-ink-900">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-ink-500 dark:text-ink-400">{BUSINESS.reviewCount} Google Reviews</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative overflow-hidden rounded-3xl border border-ink-100 shadow-2xl shadow-brand-900/15 dark:border-ink-800">
                <img src="https://images.pexels.com/photos/7681091/pexels-photo-7681091.jpeg?auto=compress&cs=tinysrgb&w=900" alt="CAC business registration consultation in Port Harcourt office with Mr. David" className="h-[420px] w-full object-cover sm:h-[480px]" loading="eager" width="900" height="480" />
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <div className="flex items-center gap-3 rounded-2xl bg-white/95 p-3.5 backdrop-blur-sm dark:bg-ink-900/90">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-sm font-semibold text-ink-900 dark:text-white">Trusted CAC Registration Agent</p>
                      <p className="truncate text-xs text-ink-500 dark:text-ink-400">{BUSINESS.addressShort}</p>
                    </div>
                  </div>
                </div>
              </div>
